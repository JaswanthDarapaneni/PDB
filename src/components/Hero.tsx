      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 py-32">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass-panel mb-8"
          >
          ...
          >
            We help Telugu-speaking creators, startups, and local businesses turn ideas into brands.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-lg text-muted-foreground mb-12 telugu-text"
          >
            మీ ఆలోచనలను బ్రాండ్‌గా మార్చే సృజనాత్మక సేవలు
          </motion.p>
          ...
          >
            ...
            <button
              ...
              className="glass-panel px-8 py-3 rounded-xl font-medium text-lg flex items-center space-x-2 hover:bg-muted transition-all group"
            >
